...
__前言:__ 学到的东西，写进读书笔记里，按照模块来，待完善，今晚先测试这个页面同步性，嗯嗯各个章节的说明,注：Ebook和github的同步需要科学上网。。，现在又出现了github contribution不被记录的情况,好像是git 用户名和邮箱设置的问题
...
>问题：
    ...
    1、提交的commit并没有被github记录，往往是本地github邮箱和用户名设置的问题。
    解决方案：git config --global user.email "你的邮件地址"
